using System;
using UnityEngine;
[Serializable] //Hace que los atributos aparezcan en el inspector (si no los scondemos)
public class TankManager
{
 ...
 public Color m_PlayerColor; //Color para el tanque 
    public Transform m_SpawnPoint; //Posición y direción en la que se generará el tanque
     [HideInInspector] 
    public int m_PlayerNumber; //Especifica con qué jugador está actuando el Game Manager
     [HideInInspector] 
    public string m_ColoredPlayerText; //String que reprsenta el color del tanque
     [HideInInspector] 
    public GameObject m_Instance; //Refernecia a la instancia del tanque cuando se crea
     [HideInInspector] 
    public int m_Wins; //Número de victorias del jugador 
 ...
 private TankShooting m_Shooting; //Referencia al script de disparo del tan que.Utilizado para deshabilitar y habilitar el control
